...
const dbStore = (set, get) => ({
  ...
  actions: {
    ...
    isLastSection: () =>
      get().sectionsTotal - get().section === 1 ? true : false,

    incSection: () =>
      set((state) =>
        !get().actions.isLastSection()
    ...
    filterList: () =>
      set({
        list: get()
          .initialList.filter((e) =>
            // Tabs filtering
            get().tabs[get().activeTab] === "all"
              ? true
              : e.species === get().tabs[get().activeTab]
          )

          // Searchstring filtering
          .filter((e) =>
            e.name.toLocaleLowerCase().includes(get().searchString)
          )

          // Spiciness filtering
          .filter((element) =>
            get()
              .spiciness.filter((e) => Object.values(e)[0])
          ...
          .filter((e) =>
            get()
              .plantSizes.filter((e) => Object.values(e)[0])
              .map((e) => Object.keys(e)[0])
          ...
          .filter((e) =>
            get()
              .fruitSizes.filter((e) => Object.values(e)[0])
              .map((e) => Object.keys(e)[0])
          ...
          .filter((e) =>
            Object.values(get().shapes[0])[0]
              ? true
              : get()
                  .shapes.filter((e) => Object.values(e)[0])
                  .map((e) => Object.keys(e)[0])
          ...
          .filter((e) =>
            Object.values(get().shapeTraits[0])[0]
              ? true
              : // if "no trait" selected
              Object.values(get().shapeTraits[1])[0] &&
                !e.fruitShape.includes(" ")
              ? true
              : // process common cases
              get()
                  .shapeTraits.filter((e) => Object.values(e)[0])
                  .map((e) => Object.keys(e)[0])
                  .includesOneOf(e.fruitShape.split(" "))
              ? true
              : false
          )
          ...
          .filter((e) =>
            Object.values(get().colors[0])[0]
              ? true
              : get()
                  .colors.filter((e) => Object.values(e)[0])
                  .map((e) => Object.keys(e)[0])
          ...
          .filter((e) =>
            Object.values(get().colorTraits[0])[0]
              ? true
              : Object.values(get().colorTraits[1])[0] &&
                !e.fruitColor.includes(" ")
              ? true
              : get()
                  .colorTraits.filter((e) => Object.values(e)[0])
                  .map((e) => Object.keys(e)[0])
                  .includesOneOf(e.fruitColor.split(" "))
              ? true
              : false
          ),
      }),
    ...
    shapeChecks: (key) => {
      if (key === "all" && !Object.values(get().shapes[0])[0]) {
        set({ shapes: forceInitialState(get().shapes, true) });
      } else {
    ...
    shapeTraitChecks: (key) => {
      if (key === "all" && !Object.values(get().shapeTraits[0])[0]) {
        set({ shapeTraits: forceInitialState(get().shapeTraits, true) });
      } else {
    ...
    colorChecks: (key) => {
      if (key === "all" && !Object.values(get().colors[0])[0]) {
        set({ colors: forceInitialState(get().colors, true) });
      } else {
    ...
    colorTraitChecks: (key) => {
      if (key === "all" && !Object.values(get().colorTraits[0])[0]) {
        set({ colorTraits: forceInitialState(get().colorTraits, true) });
      } else {
