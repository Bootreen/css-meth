const getData = async () => {
  ...
  const descUrlAtomic = 'https://raw.githubusercontent.com/Bootreen/css-meth/master/public/methodologies/atomic.dsc';
  ...
  const description = [await descFileBem.text(), await descFileOocss.text(), await descFileAtomic.text()];
  return description;
}
